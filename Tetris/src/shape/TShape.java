...
public class TShape extends TetrisShape {
	...
	public TShape(int type, int direct) {
		super(type, direct);
		// TODO Auto-generated constructor stub
	...
	public void tetrisRotate(int direct) {
		...
		case POINT_LEFT:
			...
			shape.set(3, new TetrisNode(secondNode, TetrisNode.DIR_UP));*/
			secondNode = new TetrisNode(thirdNode, TetrisNode.DIR_LEFT);
			firstNode = new TetrisNode(secondNode, TetrisNode.DIR_LEFT);
			fourthNode = new TetrisNode(secondNode, TetrisNode.DIR_UP);
			break;
		case POINT_UP:
			...
			shape.set(3, new TetrisNode(secondNode, TetrisNode.DIR_RIGHT));*/
			secondNode = new TetrisNode(thirdNode, TetrisNode.DIR_UP);
			firstNode = new TetrisNode(secondNode, TetrisNode.DIR_UP);
			fourthNode = new TetrisNode(secondNode, TetrisNode.DIR_RIGHT);
			break;
		case POINT_RIGHT:
			...
			shape.set(3, new TetrisNode(secondNode, TetrisNode.DIR_DOWN));*/
			secondNode = new TetrisNode(thirdNode, TetrisNode.DIR_RIGHT);
			firstNode = new TetrisNode(secondNode, TetrisNode.DIR_RIGHT);
			fourthNode = new TetrisNode(secondNode, TetrisNode.DIR_DOWN);
			break;
		case POINT_DOWN:
			...
			shape.set(3, new TetrisNode(secondNode, TetrisNode.DIR_LEFT));*/
			secondNode = new TetrisNode(thirdNode, TetrisNode.DIR_DOWN);
			firstNode = new TetrisNode(secondNode, TetrisNode.DIR_DOWN);
			fourthNode = new TetrisNode(secondNode, TetrisNode.DIR_LEFT);
			break;			
